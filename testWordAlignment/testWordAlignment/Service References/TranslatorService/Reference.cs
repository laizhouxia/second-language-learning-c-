...
namespace testWordAlignment.TranslatorService {
    ...
    public partial class GetTranslationsResponse : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private testWordAlignment.TranslatorService.TranslationMatch[] TranslationsField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false)]
        public testWordAlignment.TranslatorService.TranslationMatch[] Translations {
            get {
    ...
    public interface LanguageService {
        ...
        testWordAlignment.TranslatorService.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, testWordAlignment.TranslatorService.TranslateOptions options);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/GetTranslations", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsResponse")]
        System.Threading.Tasks.Task<testWordAlignment.TranslatorService.GetTranslationsResponse> GetTranslationsAsync(string appId, string text, string from, string to, int maxTranslations, testWordAlignment.TranslatorService.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArrayResponse" +
            "")]
        void AddTranslationArray(string appId, testWordAlignment.TranslatorService.Translation[] translations, string from, string to, testWordAlignment.TranslatorService.TranslateOptions options);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArrayResponse" +
            "")]
        System.Threading.Tasks.Task AddTranslationArrayAsync(string appId, testWordAlignment.TranslatorService.Translation[] translations, string from, string to, testWordAlignment.TranslatorService.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArrayRespons" +
            "e")]
        testWordAlignment.TranslatorService.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, testWordAlignment.TranslatorService.TranslateOptions options);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArrayRespons" +
            "e")]
        System.Threading.Tasks.Task<testWordAlignment.TranslatorService.GetTranslationsResponse[]> GetTranslationsArrayAsync(string appId, string[] texts, string from, string to, int maxTranslations, testWordAlignment.TranslatorService.TranslateOptions options);
        ...
        testWordAlignment.TranslatorService.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, testWordAlignment.TranslatorService.TranslateOptions options);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/TranslateArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/TranslateArrayResponse")]
        System.Threading.Tasks.Task<testWordAlignment.TranslatorService.TranslateArrayResponse[]> TranslateArrayAsync(string appId, string[] texts, string from, string to, testWordAlignment.TranslatorService.TranslateOptions options);
        ...
        testWordAlignment.TranslatorService.TranslateArray2Response[] TranslateArray2(string appId, string[] texts, string from, string to, testWordAlignment.TranslatorService.TranslateOptions options);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/TranslateArray2", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/TranslateArray2Response")]
        System.Threading.Tasks.Task<testWordAlignment.TranslatorService.TranslateArray2Response[]> TranslateArray2Async(string appId, string[] texts, string from, string to, testWordAlignment.TranslatorService.TranslateOptions options);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface LanguageServiceChannel : global::testWordAlignment.TranslatorService.LanguageService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class LanguageServiceClient : System.ServiceModel.ClientBase<global::testWordAlignment.TranslatorService.LanguageService>, global::testWordAlignment.TranslatorService.LanguageService {
        ...
        public testWordAlignment.TranslatorService.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, testWordAlignment.TranslatorService.TranslateOptions options) {
            return base.Channel.GetTranslations(appId, text, from, to, maxTranslations, options);
        }
        
        public System.Threading.Tasks.Task<testWordAlignment.TranslatorService.GetTranslationsResponse> GetTranslationsAsync(string appId, string text, string from, string to, int maxTranslations, testWordAlignment.TranslatorService.TranslateOptions options) {
        ...
        public void AddTranslationArray(string appId, testWordAlignment.TranslatorService.Translation[] translations, string from, string to, testWordAlignment.TranslatorService.TranslateOptions options) {
            base.Channel.AddTranslationArray(appId, translations, from, to, options);
        }
        
        public System.Threading.Tasks.Task AddTranslationArrayAsync(string appId, testWordAlignment.TranslatorService.Translation[] translations, string from, string to, testWordAlignment.TranslatorService.TranslateOptions options) {
            return base.Channel.AddTranslationArrayAsync(appId, translations, from, to, options);
        }
        
        public testWordAlignment.TranslatorService.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, testWordAlignment.TranslatorService.TranslateOptions options) {
            return base.Channel.GetTranslationsArray(appId, texts, from, to, maxTranslations, options);
        }
        
        public System.Threading.Tasks.Task<testWordAlignment.TranslatorService.GetTranslationsResponse[]> GetTranslationsArrayAsync(string appId, string[] texts, string from, string to, int maxTranslations, testWordAlignment.TranslatorService.TranslateOptions options) {
        ...
        public testWordAlignment.TranslatorService.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, testWordAlignment.TranslatorService.TranslateOptions options) {
            return base.Channel.TranslateArray(appId, texts, from, to, options);
        }
        
        public System.Threading.Tasks.Task<testWordAlignment.TranslatorService.TranslateArrayResponse[]> TranslateArrayAsync(string appId, string[] texts, string from, string to, testWordAlignment.TranslatorService.TranslateOptions options) {
            return base.Channel.TranslateArrayAsync(appId, texts, from, to, options);
        }
        
        public testWordAlignment.TranslatorService.TranslateArray2Response[] TranslateArray2(string appId, string[] texts, string from, string to, testWordAlignment.TranslatorService.TranslateOptions options) {
            return base.Channel.TranslateArray2(appId, texts, from, to, options);
        }
        
        public System.Threading.Tasks.Task<testWordAlignment.TranslatorService.TranslateArray2Response[]> TranslateArray2Async(string appId, string[] texts, string from, string to, testWordAlignment.TranslatorService.TranslateOptions options) {
